...
export const logUser = (userData,history) => dispatch => {
  axios.post("https://xidas-backend.herokuapp.com/users/login",userData)
      .then(res => {
        console.log(res);
  ...
  export const regUser =( userData,history )=> dispatch => {
    axios.post("https://xidas-backend.herokuapp.com/users/register",userData)
      .then(res => {
          console.log(res);
          history.push("/dashboard")
        // Save to localStorage
